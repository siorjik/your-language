  ...
  (
    ...
    return (
      <div className="flex flex-col gap-3 font-medium">
        {label && <p className="text-primary text-sm">{label}</p>}
        <Command
          ref={dropdownRef}
          {...commandProps}
          onKeyDown={(e) => {
        ...
        >
          <div
            className={cn(
              `flex items-start justify-between rounded-md border border-input px-3 py-2 text-base ring-offset-background
              focus-within:ring-2 focus-within:ring-ring focus-within:ring-offset-2 md:text-sm`,
            ...
            <div className="relative flex flex-wrap gap-1">
              ...
              <CommandPrimitive.Input
                ...
                className={cn(
                  ...
                  { 'w-full': hidePlaceholderWhenSelected, 'ml-1': selected.length !== 0 },
