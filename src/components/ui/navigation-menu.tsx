...
>(({ className, ...props }, ref) => (
  <div className={cn('w-fit absolute left-0 top-full flex justify-center view-port-menu')}>
    <NavigationMenuPrimitive.Viewport
      className={cn(
        `
        origin-top-center relative mt-1.5 h-[var(--radix-navigation-menu-viewport-height)] w-full overflow-hidden rounded-md
        border bg-popover text-popover-foreground shadow-lg data-[state=open]:animate-in data-[state=closed]:animate-out
