...
function getPayloadConfigFromPayload(config: ChartConfig, payload: any, key: string) {
  ...
  const payloadData = 'payload' in payload && typeof payload.payload === 'object' ? payload.payload : undefined

  let configKey = key
  if (key in payload && typeof payload[key] === 'string') configKey = payload[key]
  else if (payloadData && key in payloadData && typeof payloadData[key] === 'string') configKey = payloadData[key]
