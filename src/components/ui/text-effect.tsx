...
const defaultItemVariants: Variants = { hidden: { opacity: 0 }, visible: { opacity: 1 }, exit: { opacity: 0 } }
...
const createVariantsWithTransition = (baseVariants: Variants, transition?: Transition & { exit?: Transition }): Variants => {
  ...
  return {
    ...
    visible: {
      ...
      transition: { ...(hasTransition(baseVariants.visible) ? baseVariants.visible.transition : {}), ...mainTransition },
    },
    exit: {
      ...baseVariants.exit,
      transition: {
